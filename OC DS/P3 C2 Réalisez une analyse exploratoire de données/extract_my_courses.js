// Paramètres
var colonnesCSV = [
    "titreCours", "inscription", "progression", "moyenneDeClasse",
    "duree", "difficulte", "nbChapitres", "ratioQuizEvaluation", "nbEvaluations",
    "derniereMiseAJour", "idCours"], // Nom des colonnes dans le CSV à créer
...
function extraireInfosCours() {
    ...
    listeDeCours.each(function(index, ligne) {
        ...
        var cellules; // contiendra les cellules qui composent la ligne
...
// Detecte le nom des colonnes du tableau des cours tel qu'affiché sur le site
colonnesDuTableau.each(extraireTitresColonnes);
controlerColonnes();
